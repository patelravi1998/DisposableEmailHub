...
const TermsAndConditions: React.FC = () => {
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 to-gray-100">
      <Navigation />
      <Helmet>
        <title>Terms and Conditions | TempMail Service</title>
        <meta name="description" content="Read our terms and conditions for using the temporary email service" />
      </Helmet>
          ...
          <div className="prose max-w-none">
            <article className="mb-8">
              ...
              <p className="text-gray-700">
                Welcome to our temporary email generation service. By using our
            ...
            <article className="mb-8">
              ...
              <p className="text-gray-700">
                We provide temporary email services that allow you to create and use
                temporary email addresses for privacy and security purposes. Our service
                is designed to help you avoid spam and protect your personal email from
            ...
            <article className="mb-8">
              ...
              <p className="text-gray-700">
                You are responsible for maintaining the security of your temporary email
                account and should immediately notify us of any unauthorized use. We
                recommend not using temporary emails for sensitive communications as
            ...
            <article className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                use our service, including any errors, interruptions, or misuse of the
                temporary email service. The service is provided "as is" without
            ...
            <article className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                Any changes will be updated here with the revised date. Your continued
            ...
            <article className="mb-8">
              ...
              <p className="text-gray-700">
                ...
                in which our service operates. Any disputes will be resolved in the
            ...
            <article>
              ...
              <p className="text-gray-700">
                ...
                support team at <a href="mailto:support@example.com" className="text-blue-600 hover:underline">support@example.com</a>.
